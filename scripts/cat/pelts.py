...
class Pelt():
    ...
    eye_colours = ['YELLOW', 'AMBER', 'HAZEL', 'PALEGREEN', 'GREEN', 'BLUE', 'DARKBLUE', 'GREY', 'CYAN', 'EMERALD', 'PALEBLUE', 
        'PALEYELLOW', 'GOLD', 'HEATHERBLUE', 'COPPER', 'SAGE', 'COBALT', 'SUNLITICE', 'GREENYELLOW', 'BRONZE', 'SILVER', 'BERRY BANANA', 'HALLOWEEN', 'MIDNIGHT', 'WORMY', 'COTTON CANDY', 'BLUE HAZEL', 'FALL', 'SUNSET ORANGE', 'SUNSET PURPLE', 'MOONSTONE', 'WALNUT', 
        'CHRISTMAS', 'BROWN', 'SUNSET BLUE', 'CEDAR', 'LOBELIA', 'OXIDIZED', 'SNOW', 'DARK PINE', 'FOREST FIRE', 'GOLD MOON', 'ROSE', 'LIGHT FLAME', 'CLOUDY', 'TURQUOISE', 'TROPICAL GREEN', 'SWAMP', 'RAINY', 'SEAFOAM', 'AQUAMARINE', 'EARTH', 'RED', 'PUMPKIN', 'LILAC', 
        'PERIWINKLE', 'TROPICAL RED', 'POND', 'DIRT', 'VIOLET']
    yellow_eyes = ['YELLOW', 'AMBER', 'PALEYELLOW', 'GOLD', 'COPPER', 'GREENYELLOW', 'BRONZE', 'SILVER', 'BERRY BANANA', 'WORMY', 'SUNSET ORANGE', 'WALNUT', 'BROWN', 'CEDAR', 'FOREST FIRE', 'GOLD MOON', 'FALL', 'LIGHT FLAME', 'PUMPKIN', 'RED', 'DIRT', 'ROSE', 'TROPICAL RED']
    blue_eyes = ['BLUE', 'DARKBLUE', 'CYAN', 'PALEBLUE', 'HEATHERBLUE', 'COBALT', 'SUNLITICE', 'GREY', 'BLUE HAZEL', 'HALLOWEEN', 'MOONSTONE', 'SUNSET BLUE', 'COTTON CANDY', 'MIDNIGHT', 'SNOW', 'SUNSET PURPLE', 'LOBELIA', 'SEAFOAM', 'RAINY', 'CLOUDY', 'POND']
    green_eyes = ['PALEGREEN', 'GREEN', 'EMERALD', 'SAGE', 'HAZEL', 'CHRISTMAS', 'DARK PINE', 'SWAMP', 'EARTH', 'TURQUOISE', 'AQUAMARINE', 'TROPICAL GREEN', 'OXIDIZED']
    ...
    def init_pattern(self):
        if self.name in Pelt.torties:
            ...
            if self.colour:
                ...
                if not wildcard_chance or random.getrandbits(wildcard_chance) == 0:
